...
0. Possibly with more Natural Language, but this might invite more confusion.
1. Math: Universal language, nail down the details.
2. Diagrams: many diagrams. 1 pic = 1000 words.
3. Small model/prototype: Clients can see/visualize and provide informed feedback.
